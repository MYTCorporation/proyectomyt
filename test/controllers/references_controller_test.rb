...
class ReferencesControllerTest < ActionController::TestCase
  ...
  test "should create reference" do
    assert_difference('Reference.count') do
      post :create, reference: { cant: @reference.cant, description: @reference.description, name: @reference.name, talle: @reference.talle }
    end
  ...
  test "should update reference" do
    patch :update, id: @reference, reference: { cant: @reference.cant, description: @reference.description, name: @reference.name, talle: @reference.talle }
    assert_redirected_to reference_path(assigns(:reference))
  end
